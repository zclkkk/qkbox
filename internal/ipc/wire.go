...
func newRegistry(handler Handler) *ipcframework.Registry {
	...
	ipcframework.RegisterMethod(registry, api.MethodUpdateProfileDraft, handler.UpdateProfileDraft)
	...
	ipcframework.RegisterMethod(registry, api.MethodValidateProfileDraft, handler.ValidateProfileDraft)
	ipcframework.RegisterMethod(registry, api.MethodGetProfileDiagnostics, handler.GetProfileDiagnostics)
	ipcframework.RegisterMethod(registry, api.MethodCreateProfileSnapshot, handler.CreateProfileSnapshot)
	ipcframework.RegisterMethod(registry, api.MethodActivateProfileSnapshot, handler.ActivateProfileSnapshot)
	ipcframework.RegisterMethod(registry, api.MethodGetActiveProfile, handler.GetActiveProfile)
	ipcframework.RegisterMethod(registry, api.MethodGetActiveSnapshot, handler.GetActiveSnapshot)
	ipcframework.RegisterMethod(registry, api.MethodListSnapshots, handler.ListSnapshots)
	ipcframework.RegisterMethod(registry, api.MethodRollbackToSnapshot, handler.RollbackToSnapshot)
	...
	ipcframework.RegisterMethod(registry, api.MethodEngineReload, handler.EngineReload)
